...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('kategori.update', $data->id) }}" method="POST" enctype="multipart/form-data"> @csrf @method('PUT')
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="defaultFormControlInput"
                                placeholder="Nama Kategori" aria-describedby="defaultFormControlHelp" name="nama" value="{{ $data->nama }}">
                        </div>
                        <br>
